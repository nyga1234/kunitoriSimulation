...
public class Character3UI : MonoBehaviour
{
    ...
    public void ShowCharacterUI(CharacterController character)
    {
        ...
        if (character.rank == Rank.óÃéÂ == true || character.influence.influenceName == "NoneInfluence" || character == GameMain.instance.playerCharacter)
        {
